...
class HttpService {
  ...
  Future<Map<String, String>> getHeaders({
    ...
    final userToken = await SharedPreferencesService.getString(
      SharedPreferencesKeys.tokenKey,
    );
    debugPrint('User token: $userToken');
    return {'Authorization': 'Bearer $userToken', 'Content-Type': contentType};
  }
  ...
  Response _handleDioError(DioException error) {
    if (error.response != null) {
      ...
      debugPrint('Error: $errorMessage, Status Code: $statusCode');
      ...
      debugPrint('Error: $fallbackMessage');
