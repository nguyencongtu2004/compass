...
import 'package:minecraft_compass/data/services/cloudinary_service.dart'
    as _i990;
import 'package:minecraft_compass/data/services/http_service.dart' as _i251;
import 'package:minecraft_compass/data/services/locale_service.dart' as _i27;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i251.HttpService>(() => _i251.HttpService());
    ...
    gh.factory<_i27.LocaleService>(
      () => _i27.LocaleService(gh<_i460.SharedPreferences>()),
    );
    gh.lazySingleton<_i174.CompassBloc>(
      () =>
          _i174.CompassBloc(locationRepository: gh<_i276.LocationRepository>()),
    );
    gh.lazySingleton<_i727.LocaleBloc>(
      () => _i727.LocaleBloc(localeService: gh<_i27.LocaleService>()),
    );
    ...
    gh.singleton<_i390.MessageBlocManager>(
      () => _i390.MessageBlocManager(
        messageRepository: gh<_i125.MessageRepository>(),
        userRepository: gh<_i194.UserRepository>(),
      ),
    );
